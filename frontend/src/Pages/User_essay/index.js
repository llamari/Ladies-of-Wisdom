...
function EssayCorrecting() {
    ...
    async function SendCorrection() {
        ...
        try {
            const response = await axios.post('https://ladies-of-wisdom-production.up.railway.app/essay/correct', {
                user: user,
                tema: tema,
                correcao: correction,
                grade: grade,
    ...
    useEffect(() => {
        async function GetEssay() {
            const response = await axios.get(`https://ladies-of-wisdom-production.up.railway.app/essay/${user}/${tema}`);
